...
public class test1 extends JFrame implements ActionListener {
    ...
    final String[] faces = {"1", "3", "4", "5", "K","X", "y", "D"};
     ...
     public test1() {
      ...
      // Changer la taille des panels
       ...
       // Ajustez la taille du bouton
            backButton.setPreferredSize(new Dimension(8, 7));
      ...
      panel2.add(backButton, BorderLayout.CENTER);
        ...
        JLabel centerLabel1 = new JLabel("4*4", SwingConstants.CENTER);
